...
sapi.rate = 1
shell.run "GiraffeLock.bat", 0
sapi.speak "anyways dont worry about anything, no files were harmed during the process, either you or somebody put this fake trojan into your computer as a joke, so dont be mad at me. By the way sorry about the wallpaper, it had to be done, again dont be mad at me"
